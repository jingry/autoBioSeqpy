...
inputL = InputLayer(input_shape=(input_length,))
model2_out = Conv1D(filters,3,padding = 'same',activation = 'relu',strides = 1)(inputL.output)
...
newOut = GlobalMaxPooling1D()(newOut)
#newOut = keras.layers.Reshape([20,40])(newOut)
#newOut = Flatten()(newOut)
newOut = Dense(hidden_dims)(newOut)
newOut = Dropout(0.5)(newOut)
newOut = Activation('relu')(newOut)
newOut = Dense(10)(newOut)
newOut = Activation('softmax')(newOut)
